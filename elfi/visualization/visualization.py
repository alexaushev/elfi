...
def plot_gp(gp, parameter_names, axes=None, resol=50, const=None, bounds=None, true_params=None, **kwargs):
    ...
    for ix in range(n_plots):
        for jy in range(n_plots):
            if ix == jy:
                ...
                axes[jy, ix].set_aspect(aspect=(bounds[ix][1] - bounds[ix][0]) / (max(y_evidence) - min(y_evidence)))
                ...
                if true_params is not None:
                    axes[jy, ix].plot([true_params[parameter_names[ix]], 
                                       ...
                                       [min(y_evidence), max(y_evidence)], color='orange', alpha=0.5, linewidth=4)
                ...
                axes[jy, ix].set_aspect(aspect=(bounds[ix][1] - bounds[ix][0]) / (bounds[jy][1] - bounds[jy][0]))
                
                if true_params is not None:
                    axes[jy, ix].plot([true_params[parameter_names[ix]], 
                                       true_params[parameter_names[ix]]],
                                       [bounds[jy][0], bounds[jy][1]], color='orange', alpha=0.5, linewidth=4)
                    axes[jy, ix].plot([bounds[ix][0], bounds[ix][1]],
                                      [true_params[parameter_names[jy]], 
                                       true_params[parameter_names[jy]]], color='orange', alpha=0.5, linewidth=4)
